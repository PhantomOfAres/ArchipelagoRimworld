...
itemset_names = [
    ...
    "Flame Set",
    "Gem Set", "Lightning Set", "Shrine Set", "Lucky Set", "Life Set", "Poison Set", "Depth Set", "Darkbite Set",
    "Timegem Set", "Youkai Set", "Haunted Set", "Gladiator Set", "Sparkblade Set", "Swiftflight Set", "Sacredflame Set",
    "Ruins Set", "Lakeshrine Set"]
itemset_items = {}
...
specific_upgrade_names = [
    ...
    "Secondary Emerald Gem", "Secondary Garnet Gem", "Secondary Ruby Gem", "Secondary Sapphire Gem",
    "Secondary Opal Gem",
...
potion_names = [
    ...
    "Luck Potion",
    "Essence of Steel", "Evasion Potion", "Longarm Potion", "Vitality Potion"]
potion_items = {}
